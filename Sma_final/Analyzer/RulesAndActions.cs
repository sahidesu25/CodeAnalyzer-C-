...
namespace CodeAnalysis
{
    ...
    public class Elem2  // holds scope information
    {
        ...
        public override void doAction(CSsemi.CSemiExp semi)
        {
            ...
            try
            {
                ...
                else if (elem.type == "function")
                {
                    ...
                    Console.WriteLine("function cmplecity is {0}", elem.complexity);
    ...
    public class DetectUsing : ARule
    {
        ...
        public class BuildCodeAnalyzer1
        {
            ...
            public virtual Parser build()
            {/////class rule, anonymus,agg,composition and leaving scope this order should not be changed
                Parser parser = new Parser();
